        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "An otp will be sent to the inbox of lender's AADHAAR APP account. Please note that otp will not be sent to phone no.",
                textAlign: TextAlign.center,
              ),
              Form(
                key: _formKey,
                      ...
                      builder: (context) {
                        return Container(
                          ...
                          child: CustomAlertDialog(
                            title: "Request sent",
                            description:
                                "A request is sent to inbox of AADHAR APP acccount of lender.",
                            exit: false,
                          ),
                        );
                      },
