...
class _InboxState extends State<Inbox> {
  List<NotificationCard> operatorList = <NotificationCard>[
    const NotificationCard(
        title: "Request from xxxx xxxx xxxx",
        description:
            "There is am address request from xxxx xxxx xxxx, please confirm the id with borrower.",
        time: "2 days ago",
        status: 0),
    const NotificationCard(
        title: "Request from xxxx xxxx xxxx",
                      ...
                      builder: (context) {
                        return Container(
                          ...
                          child: RequestDialog(
                            ...
                            description:
                                "xxxx xxxx wants to borrow address from you.",
                            exit: false,
                          ),
                        );
                      },
